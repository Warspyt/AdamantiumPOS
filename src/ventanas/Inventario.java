...
public class Inventario extends javax.swing.JPanel {
    ...
    public void actualizaTabla() {
        ...
        ((DefaultTableCellRenderer) this.inventarioTabla.getTableHeader().getDefaultRenderer())
    ...
    private void BarrCambIdMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        this.inventario.Insertar(refOb.getNombre(), newRef, refOb.getPrecio_distribuidor(), refOb.getPrecio_venta(),
                refOb.getCantidad());
        actualizaTabla();
    }
    ...
    private void BarrBuscarMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        Objeto obj = inventario.search(
                Integer.parseInt(
                        JOptionPane.showInputDialog("Inserte la id(o referencia) del producto que desea buscar")));
        if (obj != null) {
            JOptionPane.showMessageDialog(null, "Se ha encontradoo el articulo"
                    + "\nNombre: " + obj.getNombre()
                    + "\nId: " + obj.getId()
    ...
    private void ModificarMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        Objeto obj = inventario.search(
                Integer.parseInt(
                        JOptionPane.showInputDialog("Inserte la id(o referencia) del producto que desea modificar")));
        ...
        switch (modif) {
            case "Nombre del producto":
                ...
                break;
            case "Cantidad":
                int newCantidad = Integer
                        .parseInt(JOptionPane.showInputDialog("Inserte la nueva cantidad de unidades del producto"));
                obj.setCantidad(newCantidad);
                break;
            case "Precio Venta":
                int newPrecioVenta = Integer
                        .parseInt(JOptionPane.showInputDialog("Inserte el nuevo precio de venta del producto"));
                obj.setPrecio_venta(newPrecioVenta);
                break;
            case "Precio Distribuidor":
                int newPrecioDistribuidor = Integer
                        .parseInt(JOptionPane.showInputDialog("Inserte el nuevo precio de venta del producto"));
